...
**************************************************************************************************************************************************************************************************************************************************************************************************************
 - Windows 10 2004 or newer environment to run the script (Windows 11 recommended).
 ...
 - Windows ADK/PE will be automatically downloaded and installed if not present (script requires ADK/PE components to be installed in the environment used to create an image).
...
# How to use (general)
 - Acquire a Windows 10 1909 or newer ISO, or Windows 11 21H2 or newer ISO that includes Windows 10/11 Professional or Windows 10/11 Enterprise images
 ...
 - To create a Windows 11 Professional image for Surface Pro 10:
    X:\SurfaceDeploymentAccelerator\CreateSurfaceWindowsImage.ps1 -ISO "X:\en_windows_11_business_editions_version_23h2_x64.iso" -OSSKU Pro -DestinationFolder C:\Output -Device SurfacePro10

 - To create a Windows 11 Enterprise image for use on a Surface Laptop 6:
    X:\SurfaceDeploymentAccelerator\CreateSurfaceWindowsImage.ps1 -ISO "X:\en_windows_11_business_editions_version_23h2_x64.iso" -OSSKU Enterprise -DestinationFolder C:\Output -Device SurfaceLaptop6

- To create an image WITHOUT any additional patches downloaded/injected for a Surface Laptop 5:
    X:\SurfaceDeploymentAccelerator\CreateSurfaceWindowsImage.ps1 -ISO "X:\en_windows_11_business_editions_version_23h2_x64.iso" -OSSKU Pro -DestinationFolder C:\Output -Device SurfaceLaptop5 -ServicingStack $false -CumulativeUpdate $false -CumulativeDotNetUpdate $false

- To create an image WITHOUT DotNet 3.5 or Office 365 C2R installed for a Surface Pro 9:
    X:\SurfaceDeploymentAccelerator\CreateSurfaceWindowsImage.ps1 -ISO "X:\en_windows_11_business_editions_version_23h2_x64.iso" -OSSKU Pro -DestinationFolder C:\Output -Device SurfacePro9Intel -DotNet35 $false -Office365 $false
...
***********************************************************************************************************************************************************************
 ...
 - The script supports Windows 10 1809 images or newer and Windows 11 21H2 or newer.  Support for older versions is not planned, and minimum version requirements will be updated over time as Windows releases new builds.
